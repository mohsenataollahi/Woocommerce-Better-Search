...
This file is a **handbook of patterns** for new plugins and new modules.

**ActualizedCore:** do not migrate the repo to the tree below unless the user asks. Match `actCore.php`, `includes/functions.php`, `assets/img/`. Use the patterns here (Settings API, CPT, REST, dbDelta) when adding a capability that does not exist yet — place files next to existing siblings.
